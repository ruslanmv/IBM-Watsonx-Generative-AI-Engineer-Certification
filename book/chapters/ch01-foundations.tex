...
\begin{itemize}[leftmargin=*]
    \item The five GenAI capabilities the exam tests (1.1)
    \item GenAI architecture patterns: MoE, VAE, Transformer, Reasoning models (1.2)
    \item Limitations of GenAI/LLMs and how to mitigate them (1.3)
    \item How to identify use cases and feasibility (1.4)
    \item How to choose the appropriate watsonx.ai model: parameter size, chat vs instruct, Granite family, billing classes (1.5)
    \item Optimal model architecture, including agentic architectures (1.6)
    \item Tools and techniques: RAG, LangChain, AI agents (1.7)
    \item Security risks: input, output, foundation-model risks, Granite Guardian (1.8)
\end{itemize}
