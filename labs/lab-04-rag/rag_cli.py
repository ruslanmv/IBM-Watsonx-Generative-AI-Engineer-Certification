"""Tiny CLI for the same RAG chain.

Run:
    python rag_cli.py "What is watsonx Discovery?" --show-sources
"""
...
def main():
    ...
    print("\n=== ANSWER ===\n")
    print((result.get("result") or "").strip())
    ...
    if args.show_sources:
        ...
        for i, doc in enumerate(result.get("source_documents", []), 1):
            ...
            print(f"[{i}] meta={json.dumps(meta)[:300]}  text={text} ...")
